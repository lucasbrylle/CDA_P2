...
# load dataframe
dataframe <- read.csv("/Users/nikolajhertz/Desktop/GIT/CDA_P2/data/HR_data.csv")
...
# normalize x
{
# normalize all columns, or only the physiological
all_columns <- TRUE
...
x$Cohort <- as.numeric(as.ordered(x$Cohort))
